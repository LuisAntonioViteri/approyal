...
//       },
//     );
//     _orderStreamController = StreamController<List<DatabaseOrder>>.broadcast(
//       onListen: () {
//         //Listen to a new listener suscribed to our stream controller
//         _orderStreamController.sink.add(_orders);
//       },
//     );
//     _detalleStreamController =
//         StreamController<List<DatabaseDetalleOrden>>.broadcast(
//       onListen: () {
//         //Listen to a new listener suscribed to our stream controller
//         _detalleStreamController.sink.add(_detalle);
//       },
//     );
//   }
...
//   late final StreamController<List<DatabaseOrder>> _orderStreamController;
//   late final StreamController<List<DatabaseDetalleOrden>>
//       _detalleStreamController;

//   Stream<List<DatabaseProducts>> get allProducts =>
//       _productsStreamController.stream;

//   Stream<List<DatabaseOrder>> get allOrders => _orderStreamController.stream;

//   Stream<List<DatabaseDetalleOrden>> get allDetalle =>
//       _detalleStreamController.stream;
...
//   Future<void> _cacheDetalle() async {
//     final allDetalle = await getAllDetalle();
...
//   Future<Iterable<DatabaseDetalleOrden>> getAllDetalle() async {
//     await _ensureDbIsOpen();
//     final db = _getDatabaseOrThrow();
//     final detalle = await db.query(orderTable);

//     return detalle
//         .map((detalleRow) => DatabaseDetalleOrden.fromRow(detalleRow));
//   }
